#!/usr/bin/python3
"""This is the console for AirBnB_clone_v2"""
import cmd
...
class HBNBCommand(cmd.Cmd):
    ...
    def do_EOF(self, line):
        """Quits command to exit the program at end of file"""
        return True
    ...
    def do_all(self, line):
        ...
        Exceptions:
            NameError: when object name does not match
        """
        objects = storage.all()
        my_list = []
        if not line:
    ...
    def do_update(self, line):
        """Updates an instance by updating or adding attributes
        Exceptions:
            SyntaxError: when there is no args given
            NameError: when there is no object that has the name
            IndexError: when there is no id given
    ...
    def strip_clean(self, args):
        """strips the argument and returns a string of commands
        Args:
    ...
    def default(self, line):
        """retrieves all instances of a class and
